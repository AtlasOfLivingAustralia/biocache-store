...
//  test("invalid date 26-6-5"){
//      val result = DateParser.parseDate("26-6-5")
//      expectResult(null){result.get.startYear} //should be null, as we cant determine if its 1905, or 2005
//      expectResult("06"){result.get.startMonth}
//      expectResult("06"){result.get.endMonth}
//      expectResult("26"){result.get.startDay}
//      expectResult("26"){result.get.endDay}
//      expectResult(true){result.get.singleDate}
//  }
}
