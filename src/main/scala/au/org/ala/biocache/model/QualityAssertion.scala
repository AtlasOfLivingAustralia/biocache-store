...
object QualityAssertion {
  ...
  def apply(code:Int) = {
    ...
    new QualityAssertion(uuid,null,errorCode.get.name,errorCode.get.code,null,null,2,null,null,null,null,null,null,null,null,new Date(),null,null)
  }

  def apply(errorCode:ErrorCode) = {
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null,errorCode.name,errorCode.code,null,null,0,null,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode,problemAsserted:Boolean) = {
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null,errorCode.name,errorCode.code,null,null,if(problemAsserted) 0 else 1,null,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode,problemAsserted:Boolean,comment:String) = {
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null,errorCode.name,errorCode.code,null,null,if(problemAsserted) 0 else 1,comment,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode,comment:String) = {
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null,errorCode.name,errorCode.code,null,null,0,comment,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode, qaStatus:Int, comment:String)={
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null, errorCode.name, errorCode.code,null,null, qaStatus, comment, null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode, qaStatus:Int)={
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null, errorCode.name, errorCode.code,null,null, qaStatus, null, null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(assertionCode:Int,problemAsserted:Boolean,comment:String) = {
    val uuid = UUID.randomUUID.toString
    new QualityAssertion(uuid,null,null,assertionCode,null,null,if(problemAsserted) 0 else 1,comment,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(assertionCode:Int, qaStatus:Int, comment:String) ={
    val uuid = UUID.randomUUID().toString
    new QualityAssertion(uuid,null, null, assertionCode,null,null,qaStatus,comment,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(assertionCode:Int, qaStatus:Int) ={
    val uuid = UUID.randomUUID().toString
    new QualityAssertion(uuid,null, null, assertionCode,null,null,qaStatus,null,null,null,null,null,null,null,null,new Date(),null,null)
  }
  def apply(errorCode:ErrorCode, relatedUuid: String, qaStatus:Int) = {
    val uuid = UUID.randomUUID().toString
    new QualityAssertion(uuid,null, errorCode.name, errorCode.code,null,relatedUuid,qaStatus,null,null,null,null,null,null,null,null,new Date(),null,null)
  }
...
class QualityAssertion (
  ...
  @BeanProperty var relatedRecordReason:String)
 ...
 // override def toString :String = s"name:$name, code:$code, value:$value, comment:$comment, qaStatus:$qaStatus, relatedUuid:$relatedUuid"
  ...
  def this() = this(null,null,null,-1,false,null,2,null,null,null,null,null,null,null,null,null,null,null)
