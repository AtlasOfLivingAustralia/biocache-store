...
class DAOLayerTest extends ConfigFunSuite {
  ...
  test("Kosher test") {
    persistenceManager.put("qatestkosher", "occ", Map("attr.qa"-> "[]", "bor.qa" -> "[]", "default.qa" ->"[]", "duplicates.qa"->"[20014]", "class.qa"->"[10010]", "event.qa"->"[]", "image.qa" ->"[10009,10010,10011,10012]", "loc.qa"->"[45,29,21,31,32,33,34,42]", "offline.q" ->"[20014]", "type.qa"->"[]"), true, false)
