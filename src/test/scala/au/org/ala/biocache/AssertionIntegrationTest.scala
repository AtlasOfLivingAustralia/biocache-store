 ...
 */
@Ignore
class AssertionIntegrationTest extends FunSuite {
  val rowKey = "test1"
  val rowKey2 = "test2"
  val rowKey3 = "test3"
  ...
  test("simple get all"){
    ...
    val assertions = occurrenceDAO.getUserAssertions("d07554a6-ff7f-45b7-af77-6da021891a13")
    if(!assertions.isEmpty){
      val first:QualityAssertion = assertions.iterator.next()
      println(first)
    }
  }
